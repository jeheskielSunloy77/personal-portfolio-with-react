...
const Hero = () => {
	...
	return (
		<div id='home' ref={ref} className='relative flex h-screen myContainer'>
			...
			<div
				className={`hidden my-auto ml-auto ${
					loading ? 'sm:block' : 'sm:hidden'
				} animate-pulse`}
			>
				<div className='flex items-center justify-center w-full h-[600px] bg-gray-300 rounded sm:w-[500px] dark:bg-gray-700'>
					<svg
			...
			<img
				className={`hidden my-auto ml-auto ${loading ? 'sm:hidden' : 'sm:block'}`}
