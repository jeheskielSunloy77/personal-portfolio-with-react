...
export function Card({ title, subtitle, desc, logo }) {
	return (
		<div class="card relative w-[150px] h-[150px] bg-gray-200 dark:bg-gray-800 rounded-xl mx-auto">
...
export function CardLogo({ src, backgroud }) {
	return (
		<div
			class={`${
				backgroud ? backgroud : "bg-gray-100 dark:bg-gray-900"
