...
export function Card({ title, subtitle, desc, logo }) {
	return (
		<div className="group relative w-[150px] h-[150px] bg-gray-200 dark:bg-gray-700 rounded-xl mx-auto">
			<div className="absolute bottom-0 right-0 w-full h-full flex justify-center items-center flex-col m-0 pb-8">
...
export function CardLogo({ src, backgroud, svg }) {
	return (
		<div
			...
			} group-hover:h-[40px] absolute bottom-0 right-0 w-full h-full flex justify-center items-center bg-transparant rounded-xl transition-all duration-500`}
		>
			{svg ? (
				svg
			) : (
