...
export default function ProjectCard({ title, desc, img, links, details }) {
	return (
		<div className="bg-gray-200 dark:bg-gray-800 rounded-lg mx-auto h-[500px] sm:h-[350px] sm:w-[900px] flex flex-col sm:flex-row justify-center items-center shadow-xl">
			<div class="product-image w-full sm:w-[45%] h-1/2 sm:h-full transition-all duration-300 ease-out relative overflow-hidden">
			...
			<div class="product-details sm:w-[55%] h-1/2 sm:h-full text-left overflow-hidden px-4 flex flex-col justify-center">
