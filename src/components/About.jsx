      ...
      <div className='myContainer z-10 absolute inset-0 flex items-center justify-center'>
        <div className='sm:w-1/2 mx-auto text-center sm:text-left'>
          ...
          <p className='text-medium text-lg'>
            ...
            is programing, i've been coding for a couple of years but i just
            seriously started to jump into the programing world about 6 month
            ago. my weapon of choice is
            <span className='mx-1 text-cyan-500 font-semibold'>Javascript</span>
            and i am currently married to
            <span className='mx-1 text-cyan-500 font-semibold'>ReactJS</span>. I
            also have work with other frameworks such as
