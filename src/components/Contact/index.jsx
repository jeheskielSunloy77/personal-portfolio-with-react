    ...
    return (
      <>
        ...
        <p className='text-medium text-lg text-center'>
          ...
          page. go and grab it there and dont forget to
          <span className='mx-1 text-cyan-500 font-semibold'>star me</span>
          while you're there. You can send me a message or
          <span className='mx-1 text-cyan-500 font-semibold'>find me</span>
          on one of my social down bellow. and if you want to learn more about me, you can find my
