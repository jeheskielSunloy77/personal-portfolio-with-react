...
export default function ModalForm({ setModalCV }) {
			...
			<div className="relative p-4 w-full sm:max-w-7xl">
				<div className="relative bg-gray-200 rounded-lg shadow dark:bg-gray-800">
					...
					<iframe
						...
						src={
							isEnglish
								? "https://drive.google.com/file/d/1_404x3_Va2sK9dXvzl-5-6Hapen2IRsa/preview"
								: "https://drive.google.com/file/d/15SWJ0GRuWTCll0luQ8ooBwQJD3g14OTm/preview"
						}
						allow="autoplay"
					></iframe>
				</div>
	...
	function IndonesianIcon({ setIsEnglish }) {
		return (
			<svg
	...
	function EnglishIcon({ setIsEnglish }) {
		return (
			<svg
	...
	function ButtonClose({ setModalCV }) {
		return (
			<button
