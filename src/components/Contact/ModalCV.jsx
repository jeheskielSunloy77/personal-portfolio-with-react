...
export default function ModalForm({ setModalCV }) {
	...
	return (
		<div class="fixed z-40 w-full h-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-gray-900 bg-opacity-60 centerAll">
			<div class="relative p-4 w-full sm:max-w-7xl">
				<div class="relative bg-gray-200 rounded-lg shadow dark:bg-gray-800">
					<div class="flex justify-between items-center p-5 rounded-t border-b dark:border-gray-600">
						<h3 class="text-xl font-medium text-high">View My Resume</h3>
						{isEnglish ? (
							<svg
					...
					{isEnglish ? (
						<iframe
							...
							src="https://drive.google.com/file/d/1_404x3_Va2sK9dXvzl-5-6Hapen2IRsa/preview"
							allow="autoplay"
						></iframe>
					) : (
						<iframe
							className="w-full h-[80vh]"
							src="https://drive.google.com/file/d/15SWJ0GRuWTCll0luQ8ooBwQJD3g14OTm/preview"
							allow="autoplay"
						></iframe>
					)}
				</div>
