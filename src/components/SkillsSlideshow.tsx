...
export default function SkillsSlideshow() {
	...
	return (
		<>
			<AnimatedSection>
				<div ref={ref} id='skills' className='container px-6 mx-auto py-14'>
					<h1 className='text-center text-2xl font-semibold text-gray-900 dark:text-gray-100 sm:text-4xl sm:text-left flex gap-2'>
						<motion.div
							initial={{ x: -50 }}
							whileInView={{ x: 0 }}
					...
					<article className='flex flex-col gap-4 m-auto max-w-[100vw]'>
						<div className='flex gap-4 overflow-hidden marquee'>
							<div className='flex items-center justify-around flex-shrink-0 min-w-full gap-4 marquee__group'>
								...
								<svg
									data-for='skills-slides-show-tooltip'
									data-tip='TypeScript Programming Language'
									className='grid place-items-center fill-cyan-500 bg-white dark:bg-black aspect-[2/1] min-h-[3rem] p-2 md:p-4 rounded-md hover:fill-cyan-400'
								>
								...
								<svg
									data-for='skills-slides-show-tooltip'
									data-tip='The Go Programming Language'
									className='grid place-items-center fill-cyan-500 bg-white dark:bg-black aspect-[2/1] min-h-[3rem] p-2 md:p-4 rounded-md hover:fill-cyan-400'
								>
								...
								<svg
									data-for='skills-slides-show-tooltip'
									data-tip='Linux Operating System'
									className='grid place-items-center fill-cyan-500 bg-white dark:bg-black aspect-[2/1] min-h-[3rem] p-2 md:p-4 rounded-md hover:fill-cyan-400'
								>
									<use xlinkHref='#linux' />
								</svg>
						...
						<div className='flex gap-4 overflow-hidden marquee marquee--reverse'>
							<div className='flex items-center justify-around flex-shrink-0 min-w-full gap-4 marquee__group'>
								<svg
									data-for='skills-slides-show-tooltip'
									data-tip='Redux State Management Library'
									className='grid place-items-center fill-cyan-500 bg-white dark:bg-black aspect-[2/1] min-h-[3rem] p-2 md:p-4 rounded-md hover:fill-cyan-400'
								>
									<use xlinkHref='#redux' />
								</svg>
								<svg
									data-for='skills-slides-show-tooltip'
									data-tip='GitHub Version Control System'
									className='grid place-items-center fill-cyan-500 bg-white dark:bg-black aspect-[2/1] min-h-[3rem] p-2 md:p-4 rounded-md hover:fill-cyan-400'
								>
								...
								<svg
									data-for='skills-slides-show-tooltip'
									data-tip='Jest Testing Framework'
									className='grid place-items-center fill-cyan-500 bg-white dark:bg-black aspect-[2/1] min-h-[3rem] p-2 md:p-4 rounded-md hover:fill-cyan-400'
								>
									<use xlinkHref='#jest' />
								</svg>
								<svg
									data-for='skills-slides-show-tooltip'
									data-tip='Vercel Cloud Platform'
									className='grid place-items-center fill-cyan-500 bg-white dark:bg-black aspect-[2/1] min-h-[3rem] p-2 md:p-4 rounded-md hover:fill-cyan-400'
								>
								...
								<svg
									data-for='skills-slides-show-tooltip'
									data-tip='NodeJS Runtime Environment'
									className='grid place-items-center fill-cyan-500 bg-white dark:bg-black aspect-[2/1] min-h-[3rem] p-2 md:p-4 rounded-md hover:fill-cyan-400'
								>
					...
					<svg className='hidden' xmlns='http://www.w3.org/2000/svg'>
						<defs>
							<symbol id='golang' viewBox='0 0 24 24'>
							...
							<symbol id='typescript' viewBox='0 0 512 512'>
							...
							<symbol id='tailwind' viewBox='0 0 24 24'>
								<path
									fillRule='evenodd'
									clipRule='evenodd'
							...
							<symbol id='postgres' viewBox='0 0 32 32'>
							...
							<symbol id='vercel' viewBox='0 0 24 24'>
								<path d='M12 1L24 22H0L12 1Z' />
							</symbol>
							<symbol id='jest' viewBox='0 0 24 24'>
							...
							<symbol id='redux' viewBox='0 0 24 24'>
			...
			<ReactTooltip id='skills-slides-show-tooltip' />
		</>
	)
}
